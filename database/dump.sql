...
ALTER TABLE IF EXISTS ONLY public.author_components DROP CONSTRAINT IF EXISTS author_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.author_components DROP CONSTRAINT IF EXISTS author_components_pkey;
...
ALTER TABLE IF EXISTS public.author_components ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.author_components_id_seq;
DROP TABLE IF EXISTS public.author_components;
...
--
-- Name: author; Type: TABLE; Schema: public; Owner: strapi
--
...
ALTER TABLE public.author OWNER TO strapi;

--
-- Name: author_components; Type: TABLE; Schema: public; Owner: strapi
--

CREATE TABLE public.author_components (
    id integer NOT NULL,
...
ALTER TABLE public.author_components OWNER TO strapi;

--
-- Name: author_components_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--

CREATE SEQUENCE public.author_components_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.author_components_id_seq OWNER TO strapi;

--
-- Name: author_components_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--

ALTER SEQUENCE public.author_components_id_seq OWNED BY public.author_components.id;


--
-- Name: author_id_seq; Type: SEQUENCE; Schema: public; Owner: strapi
--
...
ALTER TABLE public.author_id_seq OWNER TO strapi;

--
-- Name: author_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: strapi
--
...
--
-- Name: author id; Type: DEFAULT; Schema: public; Owner: strapi
--
...
--
-- Name: author_components id; Type: DEFAULT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.author_components ALTER COLUMN id SET DEFAULT nextval('public.author_components_id_seq'::regclass);
...
--
-- Data for Name: author; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.author (id, published_at, created_by, updated_by, created_at, updated_at, name, role, description) FROM stdin;
1	2020-12-19 16:45:21.756-03	1	1	2020-12-19 16:44:47.948-03	2020-12-20 10:56:12.183-03	Willian Justen	Instrutor	Desenvolvedor Front-end há mais de 10 anos, tendo trabalhado em grandes empresas como Toptal, Globo.com e Huge. Tenho um blog com mais de 200 mil views por mês, além de ter diversos cursos na Udemy, alcançando a incrível marca de mais de 200 mil alunos!
2	2020-12-20 10:57:51.605-03	1	1	2020-12-20 10:57:48.289-03	2020-12-20 10:57:51.645-03	Guilherme Louro	Instrutor	Desenvolvedor Fullstack há muitos anos, com conhecimento em diversas linguagens de programação. Já liderou grandes projetos e trabalha atualmente na Personare, um dos maiores portais de autoconhecimento do Brasil. Nas horas vagas é o criador e mantenedor do Netfla, site de notícias do Flamengo com mais de meio milhão de views por mês!
3	2020-12-20 10:59:11.552-03	1	1	2020-12-20 10:58:55.23-03	2020-12-20 10:59:11.585-03	Marcos Oliveira	Designer	Front-End e UI Designer há alguns anos. Atualmente trabalha na Lukin Co. Já participou de diversos tipos de projetos, na área da saúde, streaming e varejo. Sempre dividido entre design e programação. No tempo livre sempre está envolvido com a comunidade, organizando eventos e meetups.
\.


--
-- Data for Name: author_components; Type: TABLE DATA; Schema: public; Owner: strapi
--

COPY public.author_components (id, field, "order", component_type, component_id, author_id) FROM stdin;
2	socialLinks	1	components_page_social_links	18	1
3	socialLinks	2	components_page_social_links	19	1
4	socialLinks	1	components_page_social_links	20	2
5	socialLinks	2	components_page_social_links	21	2
6	socialLinks	1	components_page_social_links	22	3
7	socialLinks	2	components_page_social_links	23	3
8	socialLinks	3	components_page_social_links	24	3
\.
...
18	Twitter	https://twitter.com/Willian_justen
19	GitHub	https://github.com/willianjusten
20	Twitter	https://twitter.com/guilhermelouro
21	GitHub	https://github.com/guilouro
22	Twitter	https://twitter.com/vmaarcosp
23	GitHub	https://github.com/vmarcosp
24	Dribbble	https://dribbble.com/vmarcosp
\.
...
71	model_def_page.section-concepts	{"uid":"page.section-concepts","collectionName":"components_page_section_concepts","info":{"name":"sectionConcepts","icon":"clipboard-list"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"concepts":{"type":"component","repeatable":true,"component":"page.concepts"}}}	object	\N	\N
...
72	model_def_page.section-faq	{"uid":"page.section-faq","collectionName":"components_page_section_faqs","info":{"name":"sectionFaq","icon":"question","description":""},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"questions":{"type":"component","repeatable":true,"component":"page.questions","min":2,"required":true}}}	object	\N	\N
...
63	model_def_page.header	{"uid":"page.header","collectionName":"components_page_headers","info":{"name":"header","icon":"heading"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","default":"React Avançado","required":true},"description":{"type":"text","required":true},"button":{"type":"component","repeatable":false,"component":"page.button"},"imagem":{"model":"file","via":"related","allowedTypes":["images"],"plugin":"upload","required":true}}}	object	\N	\N
...
62	model_def_page.concepts	{"uid":"page.concepts","collectionName":"components_page_concepts","info":{"name":"concepts","icon":"list-alt"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true}}}	object	\N	\N
...
66	model_def_page.questions	{"uid":"page.questions","collectionName":"components_page_questions","info":{"name":"questions","icon":"question-circle","description":""},"options":{"timestamps":false},"attributes":{"question":{"type":"text","required":true},"answer":{"type":"richtext","required":true}}}	object	\N	\N
...
69	model_def_page.section-about-us	{"uid":"page.section-about-us","collectionName":"components_page_section_aboutuses","info":{"name":"sectionAboutUs","icon":"database"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"authors":{"collection":"author","attribute":"author","column":"id","isVirtual":true}}}	object	\N	\N
...
55	plugin_content_manager_configuration_components::page.section-reviews	{"uid":"page.section-reviews","isComponent":true,"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"title","defaultSortBy":"title","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"Id","searchable":false,"sortable":false}},"reviews":{"edit":{"label":"Reviews","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Reviews","searchable":false,"sortable":false}},"title":{"edit":{"label":"Title","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Title","searchable":true,"sortable":true}}},"layouts":{"list":["id","title"],"edit":[[{"name":"title","size":6}],[{"name":"reviews","size":12}]],"editRelations":[]}}	object		
74	model_def_page.section-reviews	{"uid":"page.section-reviews","collectionName":"components_page_section_reviews","info":{"name":"sectionReviews","icon":"star","description":""},"options":{"timestamps":false},"attributes":{"reviews":{"type":"component","repeatable":true,"component":"page.reviews","required":true,"min":4},"title":{"type":"string","required":true}}}	object	\N	\N
76	model_def_page.social-links	{"uid":"page.social-links","collectionName":"components_page_social_links","info":{"name":"SocialLinks","icon":"network-wired"},"options":{"timestamps":false},"attributes":{"title":{"type":"enumeration","enum":["Twitter","GitHub","Dribbble","Facebook"],"default":"Twitter","required":true},"url":{"type":"string","required":true}}}	object	\N	\N
26	plugin_content_manager_configuration_components::page.header	{"uid":"page.header","isComponent":true,"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"title","defaultSortBy":"title","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"Id","searchable":false,"sortable":false}},"title":{"edit":{"label":"Title","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Title","searchable":true,"sortable":true}},"description":{"edit":{"label":"Description","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Description","searchable":true,"sortable":true}},"button":{"edit":{"label":"Button","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Button","searchable":false,"sortable":false}},"imagem":{"edit":{"label":"Imagem","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Imagem","searchable":false,"sortable":false}}},"layouts":{"list":["id","title","description","imagem"],"edit":[[{"name":"title","size":6}],[{"name":"description","size":6}],[{"name":"button","size":12}],[{"name":"imagem","size":6}]],"editRelations":[]}}	object		
...
64	model_def_page.modules	{"uid":"page.modules","collectionName":"components_page_modules","info":{"name":"modules","icon":"money-check"},"options":{"timestamps":false},"attributes":{"title":{"type":"string","required":true},"subtitle":{"type":"string","required":true},"description":{"type":"richtext","required":true}}}	object	\N	\N
65	model_def_page.pricing-box	{"uid":"page.pricing-box","collectionName":"components_page_pricing_boxes","info":{"name":"pricingBox","icon":"dollar-sign","description":""},"options":{"timestamps":false},"attributes":{"totalPrice":{"type":"integer","required":true},"numberInstallments":{"type":"integer","required":true},"priceInstallment":{"type":"integer","required":true},"benefits":{"type":"richtext","default":"Create Benefits list","required":true},"button":{"type":"component","repeatable":false,"component":"page.button","required":true}}}	object	\N	\N
78	model_def_application::author.author	{"uid":"application::author.author","collectionName":"author","kind":"collectionType","info":{"name":"author","description":""},"options":{"increments":true,"timestamps":["created_at","updated_at"],"draftAndPublish":true},"attributes":{"photo":{"model":"file","via":"related","allowedTypes":["images"],"plugin":"upload","required":true},"name":{"type":"string","required":true},"role":{"type":"string","required":true},"socialLinks":{"type":"component","repeatable":true,"component":"page.social-links","required":true},"description":{"type":"text","required":true},"published_at":{"type":"datetime","configurable":false},"created_by":{"model":"user","plugin":"admin","configurable":false,"writable":false,"private":true},"updated_by":{"model":"user","plugin":"admin","configurable":false,"writable":false,"private":true}}}	object	\N	\N
47	plugin_content_manager_configuration_content_types::application::author.author	{"uid":"application::author.author","settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"name","defaultSortBy":"name","defaultSortOrder":"ASC"},"metadatas":{"published_at":{"edit":{"label":"Published_at","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"Published_at","searchable":true,"sortable":true}},"created_at":{"edit":{"label":"Created_at","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"Created_at","searchable":true,"sortable":true}},"name":{"edit":{"label":"Name","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Name","searchable":true,"sortable":true}},"socialLinks":{"edit":{"label":"SocialLinks","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"SocialLinks","searchable":false,"sortable":false}},"photo":{"edit":{"label":"Photo","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Photo","searchable":false,"sortable":false}},"role":{"edit":{"label":"Role","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Role","searchable":true,"sortable":true}},"updated_at":{"edit":{"label":"Updated_at","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"Updated_at","searchable":true,"sortable":true}},"id":{"edit":{},"list":{"label":"Id","searchable":true,"sortable":true}},"description":{"edit":{"label":"Description","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"Description","searchable":true,"sortable":true}}},"layouts":{"edit":[[{"name":"photo","size":6},{"name":"description","size":6}],[{"name":"name","size":6}],[{"name":"role","size":6}],[{"name":"socialLinks","size":12}]],"editRelations":[],"list":["id","photo","name","role"]}}	object		
...
1	2020-07-17 22:41:34.291-03	2020-12-20 11:15:34.234-03	2020-07-17 22:41:34.291-03	\N	1
\.
...
1	Marcos	vinicius	\N	marcoswebmaster@hotmail.com	$2a$10$jIh83E6hsMHcbK4Hu2/TwOZR0eKinPuh56yCD9FuUFlbPRirNPbXC	\N	\N	t	\N
\.
...
1	plugins::upload.read	\N	\N	[]	2	2020-12-12 21:15:45.102-03	2020-12-12 21:15:45.121-03
2	plugins::upload.assets.create	\N	\N	[]	2	2020-12-12 21:15:45.102-03	2020-12-12 21:15:45.122-03
3	plugins::upload.assets.update	\N	\N	[]	2	2020-12-12 21:15:45.102-03	2020-12-12 21:15:45.122-03
4	plugins::upload.assets.download	\N	\N	[]	2	2020-12-12 21:15:45.102-03	2020-12-12 21:15:45.123-03
5	plugins::upload.assets.copy-link	\N	\N	[]	2	2020-12-12 21:15:45.103-03	2020-12-12 21:15:45.123-03
6	plugins::upload.read	\N	\N	["admin::is-creator"]	3	2020-12-12 21:15:45.157-03	2020-12-12 21:15:45.174-03
7	plugins::upload.assets.create	\N	\N	[]	3	2020-12-12 21:15:45.158-03	2020-12-12 21:15:45.174-03
8	plugins::upload.assets.update	\N	\N	["admin::is-creator"]	3	2020-12-12 21:15:45.158-03	2020-12-12 21:15:45.174-03
9	plugins::upload.assets.download	\N	\N	[]	3	2020-12-12 21:15:45.158-03	2020-12-12 21:15:45.174-03
10	plugins::upload.assets.copy-link	\N	\N	[]	3	2020-12-12 21:15:45.158-03	2020-12-12 21:15:45.174-03
11	plugins::content-manager.explorer.create	plugins::users-permissions.user	["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role"]	[]	1	2020-12-12 21:15:45.231-03	2020-12-12 21:15:45.261-03
12	plugins::content-manager.explorer.read	plugins::users-permissions.user	["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role"]	[]	1	2020-12-12 21:15:45.231-03	2020-12-12 21:15:45.261-03
13	plugins::content-manager.explorer.update	plugins::users-permissions.user	["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role"]	[]	1	2020-12-12 21:15:45.232-03	2020-12-12 21:15:45.261-03
14	plugins::content-manager.explorer.delete	plugins::users-permissions.user	\N	[]	1	2020-12-12 21:15:45.232-03	2020-12-12 21:15:45.262-03
15	plugins::content-type-builder.read	\N	\N	[]	1	2020-12-12 21:15:45.232-03	2020-12-12 21:15:45.262-03
16	plugins::upload.read	\N	\N	[]	1	2020-12-12 21:15:45.232-03	2020-12-12 21:15:45.262-03
17	plugins::upload.assets.create	\N	\N	[]	1	2020-12-12 21:15:45.232-03	2020-12-12 21:15:45.262-03
18	plugins::upload.assets.update	\N	\N	[]	1	2020-12-12 21:15:45.233-03	2020-12-12 21:15:45.262-03
19	plugins::upload.assets.download	\N	\N	[]	1	2020-12-12 21:15:45.233-03	2020-12-12 21:15:45.262-03
20	plugins::upload.assets.copy-link	\N	\N	[]	1	2020-12-12 21:15:45.233-03	2020-12-12 21:15:45.263-03
21	plugins::upload.settings.read	\N	\N	[]	1	2020-12-12 21:15:45.309-03	2020-12-12 21:15:45.318-03
22	plugins::content-manager.single-types.configure-view	\N	\N	[]	1	2020-12-12 21:15:45.32-03	2020-12-12 21:15:45.352-03
23	plugins::content-manager.collection-types.configure-view	\N	\N	[]	1	2020-12-12 21:15:45.32-03	2020-12-12 21:15:45.353-03
24	plugins::content-manager.components.configure-layout	\N	\N	[]	1	2020-12-12 21:15:45.321-03	2020-12-12 21:15:45.353-03
25	plugins::users-permissions.roles.create	\N	\N	[]	1	2020-12-12 21:15:45.321-03	2020-12-12 21:15:45.353-03
26	plugins::users-permissions.roles.read	\N	\N	[]	1	2020-12-12 21:15:45.321-03	2020-12-12 21:15:45.353-03
27	plugins::users-permissions.roles.update	\N	\N	[]	1	2020-12-12 21:15:45.321-03	2020-12-12 21:15:45.353-03
28	plugins::users-permissions.roles.delete	\N	\N	[]	1	2020-12-12 21:15:45.321-03	2020-12-12 21:15:45.353-03
29	plugins::users-permissions.providers.read	\N	\N	[]	1	2020-12-12 21:15:45.322-03	2020-12-12 21:15:45.353-03
30	plugins::users-permissions.providers.update	\N	\N	[]	1	2020-12-12 21:15:45.322-03	2020-12-12 21:15:45.354-03
31	plugins::users-permissions.email-templates.read	\N	\N	[]	1	2020-12-12 21:15:45.378-03	2020-12-12 21:15:45.4-03
32	plugins::users-permissions.email-templates.update	\N	\N	[]	1	2020-12-12 21:15:45.401-03	2020-12-12 21:15:45.428-03
33	plugins::users-permissions.advanced-settings.read	\N	\N	[]	1	2020-12-12 21:15:45.409-03	2020-12-12 21:15:45.44-03
34	plugins::users-permissions.advanced-settings.update	\N	\N	[]	1	2020-12-12 21:15:45.41-03	2020-12-12 21:15:45.44-03
35	admin::marketplace.read	\N	\N	[]	1	2020-12-12 21:15:45.41-03	2020-12-12 21:15:45.44-03
36	admin::marketplace.plugins.install	\N	\N	[]	1	2020-12-12 21:15:45.41-03	2020-12-12 21:15:45.441-03
37	admin::marketplace.plugins.uninstall	\N	\N	[]	1	2020-12-12 21:15:45.41-03	2020-12-12 21:15:45.441-03
38	admin::webhooks.create	\N	\N	[]	1	2020-12-12 21:15:45.411-03	2020-12-12 21:15:45.441-03
39	admin::webhooks.read	\N	\N	[]	1	2020-12-12 21:15:45.411-03	2020-12-12 21:15:45.441-03
40	admin::webhooks.update	\N	\N	[]	1	2020-12-12 21:15:45.411-03	2020-12-12 21:15:45.441-03
41	admin::webhooks.delete	\N	\N	[]	1	2020-12-12 21:15:45.45-03	2020-12-12 21:15:45.48-03
42	admin::users.create	\N	\N	[]	1	2020-12-12 21:15:45.481-03	2020-12-12 21:15:45.506-03
43	admin::users.read	\N	\N	[]	1	2020-12-12 21:15:45.492-03	2020-12-12 21:15:45.516-03
44	admin::users.update	\N	\N	[]	1	2020-12-12 21:15:45.492-03	2020-12-12 21:15:45.516-03
45	admin::users.delete	\N	\N	[]	1	2020-12-12 21:15:45.492-03	2020-12-12 21:15:45.517-03
46	admin::roles.create	\N	\N	[]	1	2020-12-12 21:15:45.492-03	2020-12-12 21:15:45.517-03
47	admin::roles.read	\N	\N	[]	1	2020-12-12 21:15:45.493-03	2020-12-12 21:15:45.517-03
48	admin::roles.update	\N	\N	[]	1	2020-12-12 21:15:45.494-03	2020-12-12 21:15:45.517-03
49	admin::roles.delete	\N	\N	[]	1	2020-12-12 21:15:45.494-03	2020-12-12 21:15:45.517-03
53	plugins::content-manager.explorer.delete	application::landing-page.landing-page	\N	[]	1	2020-12-13 15:08:08.775-03	2020-12-13 15:08:08.796-03
54	plugins::content-manager.explorer.publish	application::landing-page.landing-page	\N	[]	1	2020-12-13 15:08:08.775-03	2020-12-13 15:08:08.796-03
73	plugins::content-manager.explorer.delete	application::author.author	\N	[]	1	2020-12-13 16:28:17.778-03	2020-12-13 16:28:17.796-03
74	plugins::content-manager.explorer.publish	application::author.author	\N	[]	1	2020-12-13 16:28:17.778-03	2020-12-13 16:28:17.796-03
77	plugins::content-manager.explorer.update	application::author.author	["photo", "role", "socialLinks.title", "socialLinks.url", "description", "name"]	[]	1	2020-12-13 16:35:38.416-03	2020-12-19 16:09:40-03
75	plugins::content-manager.explorer.create	application::author.author	["photo", "role", "socialLinks.title", "socialLinks.url", "description", "name"]	[]	1	2020-12-13 16:35:38.415-03	2020-12-19 16:09:40-03
76	plugins::content-manager.explorer.read	application::author.author	["photo", "role", "socialLinks.title", "socialLinks.url", "description", "name"]	[]	1	2020-12-13 16:35:38.415-03	2020-12-19 16:09:40.001-03
126	plugins::content-manager.explorer.create	application::landing-page.landing-page	["logo", "header.title", "header.description", "header.button.label", "header.button.url", "header.imagem", "sectionAboutProject.title", "sectionAboutProject.description", "sectionAboutProject.image", "sectionTech.title", "sectionTech.techIcons.icon", "sectionTech.techIcons.title", "sectionConcepts.title", "sectionConcepts.concepts.title", "sectionModules.title", "sectionModules.modules.title", "sectionModules.modules.subtitle", "sectionModules.modules.description", "sectionAgenda.title", "sectionAgenda.description", "pricingBox.totalPrice", "pricingBox.numberInstallments", "pricingBox.priceInstallment", "pricingBox.benefits", "pricingBox.button.label", "pricingBox.button.url", "sectionReviews.reviews.name", "sectionReviews.reviews.text", "sectionReviews.reviews.photo", "sectionFaq.title", "sectionFaq.questions.question", "sectionFaq.questions.answer", "sectionAboutUs.title", "sectionAboutUs.authors", "sectionReviews.title"]	[]	1	2020-12-20 11:14:14.655-03	2020-12-20 11:39:19.592-03
127	plugins::content-manager.explorer.read	application::landing-page.landing-page	["logo", "header.title", "header.description", "header.button.label", "header.button.url", "header.imagem", "sectionAboutProject.title", "sectionAboutProject.description", "sectionAboutProject.image", "sectionTech.title", "sectionTech.techIcons.icon", "sectionTech.techIcons.title", "sectionConcepts.title", "sectionConcepts.concepts.title", "sectionModules.title", "sectionModules.modules.title", "sectionModules.modules.subtitle", "sectionModules.modules.description", "sectionAgenda.title", "sectionAgenda.description", "pricingBox.totalPrice", "pricingBox.numberInstallments", "pricingBox.priceInstallment", "pricingBox.benefits", "pricingBox.button.label", "pricingBox.button.url", "sectionReviews.reviews.name", "sectionReviews.reviews.text", "sectionReviews.reviews.photo", "sectionFaq.title", "sectionFaq.questions.question", "sectionFaq.questions.answer", "sectionAboutUs.title", "sectionAboutUs.authors", "sectionReviews.title"]	[]	1	2020-12-20 11:14:14.655-03	2020-12-20 11:39:19.593-03
128	plugins::content-manager.explorer.update	application::landing-page.landing-page	["logo", "header.title", "header.description", "header.button.label", "header.button.url", "header.imagem", "sectionAboutProject.title", "sectionAboutProject.description", "sectionAboutProject.image", "sectionTech.title", "sectionTech.techIcons.icon", "sectionTech.techIcons.title", "sectionConcepts.title", "sectionConcepts.concepts.title", "sectionModules.title", "sectionModules.modules.title", "sectionModules.modules.subtitle", "sectionModules.modules.description", "sectionAgenda.title", "sectionAgenda.description", "pricingBox.totalPrice", "pricingBox.numberInstallments", "pricingBox.priceInstallment", "pricingBox.benefits", "pricingBox.button.label", "pricingBox.button.url", "sectionReviews.reviews.name", "sectionReviews.reviews.text", "sectionReviews.reviews.photo", "sectionFaq.title", "sectionFaq.questions.question", "sectionFaq.questions.answer", "sectionAboutUs.title", "sectionAboutUs.authors", "sectionReviews.title"]	[]	1	2020-12-20 11:14:14.655-03	2020-12-20 11:39:19.593-03
\.
...
1	Super Admin	strapi-super-admin	Super Admins can access and manage all features and settings.	2020-12-12 21:15:45.033-03	2020-12-12 21:15:45.033-03
2	Editor	strapi-editor	Editors can manage and publish contents including those of other users.	2020-12-12 21:15:45.057-03	2020-12-12 21:15:45.057-03
3	Author	strapi-author	Authors can manage the content they have created.	2020-12-12 21:15:45.077-03	2020-12-12 21:15:45.077-03
\.
...
95	6	1	author	photo	1
96	7	2	author	photo	1
97	8	3	author	photo	1
115	29	1	components_page_headers	imagem	1
116	28	1	components_page_section_about_projects	image	1
117	2	1	components_page_tech_icons	icon	1
118	22	2	components_page_tech_icons	icon	1
119	21	3	components_page_tech_icons	icon	1
120	26	4	components_page_tech_icons	icon	1
121	27	5	components_page_tech_icons	icon	1
122	19	6	components_page_tech_icons	icon	1
123	20	7	components_page_tech_icons	icon	1
124	23	8	components_page_tech_icons	icon	1
125	24	9	components_page_tech_icons	icon	1
126	18	10	components_page_tech_icons	icon	1
127	4	1	components_page_reviews	photo	1
128	15	2	components_page_reviews	photo	1
129	16	3	components_page_reviews	photo	1
130	12	4	components_page_reviews	photo	1
131	30	1	landing_pages	logo	1
\.
...
--
-- Name: author_components_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--

SELECT pg_catalog.setval('public.author_components_id_seq', 8, true);


--
-- Name: author_id_seq; Type: SEQUENCE SET; Schema: public; Owner: strapi
--
...
SELECT pg_catalog.setval('public.components_page_section_aboutuses__authors_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.components_page_social_links_id_seq', 24, true);
...
SELECT pg_catalog.setval('public.core_store_id_seq', 91, true);
...
SELECT pg_catalog.setval('public.strapi_permission_id_seq', 128, true);
...
SELECT pg_catalog.setval('public.upload_file_morph_id_seq', 131, true);
...
--
-- Name: author_components author_components_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.author_components
    ADD CONSTRAINT author_components_pkey PRIMARY KEY (id);


--
-- Name: author author_pkey; Type: CONSTRAINT; Schema: public; Owner: strapi
--
...
--
-- Name: author_components author_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: strapi
--

ALTER TABLE ONLY public.author_components
    ADD CONSTRAINT author_id_fk FOREIGN KEY (author_id) REFERENCES public.author(id) ON DELETE CASCADE;
